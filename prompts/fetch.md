...
4. If the URL is unreachable or the content cannot be parsed, report the error clearly.

## Output

Use the `save_fetched_content` tool to persist the extracted title and content back to the link document.
