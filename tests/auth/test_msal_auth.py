...
def test_get_auth_url_returns_uri(mock_msal_class):
    mock_app = MagicMock()
...
@patch("agent_stack.auth.msal_auth.msal.ConfidentialClientApplication")
def test_get_auth_flow_returns_flow_dict(mock_msal_class):
    mock_app = MagicMock()
...
@patch("agent_stack.auth.msal_auth.msal.ConfidentialClientApplication")
def test_complete_auth_returns_none_on_error(mock_msal_class):
    mock_app = MagicMock()
...
@patch("agent_stack.auth.msal_auth.msal.ConfidentialClientApplication")
def test_complete_auth_returns_result_on_success(mock_msal_class):
    mock_app = MagicMock()
